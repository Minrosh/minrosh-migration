  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-16">
      ...
      <p className="mt-2 text-slate-600">
        Hi {customer.name || "there"}, use this private link (unique token) to upload your files and view your live
        visa status updates. Keep this URL confidential; request a new link from us if it may have been exposed.
      </p>
