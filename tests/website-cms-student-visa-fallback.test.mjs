...
const SLUG = "/student-visa-australia";

describe("student-visa-australia CMS route fallback", () => {
  afterEach(() => {
  ...
  it("returns published sections when CMS flag is on and page is published", () => {
      ...
      sections: [
        {
          ...
          type: "hero",
          props: {
            heading: "CMS Student visa heading",
    ...
    expect(rendered?.sections?.[0]?.props?.heading).toBe("CMS Student visa heading");
  });
