...
/** Public allow-list for consultation length (minutes). */
export const CONSULT_DURATIONS_ALLOWED = /** @type {const} */ (["30"]);

/** Only 30-minute consultation slots (aligned with `lib/consultation-slot-policy` duration). */
const CONSULT_DURATIONS = new Set(CONSULT_DURATIONS_ALLOWED);
