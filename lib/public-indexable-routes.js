...
export const STATIC_SITEMAP_ROUTES = [
  ...
  "/referral-program",
  "/meet-the-team",
  "/migration-for-healthcare-workers-australia",
  "/student-migration-over-25-australia",
];
...
export const SITEMAP_PRIORITIES = {
  ...
  "/post-study-visa-australia": 0.88,
...
export const GLOBAL_HEADER_PRIMARY_LINKS = [
  { href: "/", label: "Home" },
  { href: "/australian-visas-official-sources", label: "Australian visas" },
  { href: "/popular-routes", label: "POPULAR ROUTES" },
