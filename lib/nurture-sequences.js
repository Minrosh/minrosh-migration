...
function buildStepCopy(stepDay, firstName) {
  ...
  if (stepDay === 1) {
    return {
      ...
      text: [
        ...
        "We attached our brochure so you can review your options before your consultation.",
        "",
        `Read latest updates: ${site}/updates`,
      ].join("\n"),
      html: `<p>${hello}</p><p>Thank you for contacting MinRosh Migration.</p><p>We attached our brochure so you can review your options before your consultation.</p><p><a href="${site}/updates">Read latest migration updates</a></p>`,
      attachBrochure: true,
    };
  }
  if (stepDay === 7) {
    return {
      subject: "Did you know engineers are in high demand in Brisbane?",
      text: [
        hello,
        "",
        "Brisbane and wider Queensland continue to need skilled engineers.",
        "If your profile is ready, this can improve your pathway planning.",
        "",
        `Read more updates: ${site}/updates`,
      ].join("\n"),
      html: `<p>${hello}</p><p>Brisbane and wider Queensland continue to need skilled engineers.</p><p>If your profile is ready, this can improve your pathway planning.</p><p><a href="${site}/updates">Read more migration updates</a></p>`,
  ...
  return {
    ...
    text: [
      hello,
      "",
      "Visa settings and processing priorities for 2026 are evolving.",
      "Knowing what changed early helps you avoid delays and rework.",
      "",
      `See the latest update notes: ${site}/updates`,
    ].join("\n"),
    html: `<p>${hello}</p><p>Visa settings and processing priorities for 2026 are evolving.</p><p>Knowing what changed early helps you avoid delays and rework.</p><p><a href="${site}/updates">See the latest update notes</a></p>`,
    attachBrochure: false,
  };
}
