...
export function computeLeadScores(lead) {
  ...
  if (lead?.source === "ai_navigator_funnel") intentScore += 15; // AI leads have higher intent
  ...
  if (/immediately|within 3 months/.test(msg)) visaUrgency += 30; // Match AI v2/v3 terms
  ...
  if (lead?.quizCompleted === true) docReadiness += 10;
  ...
  if (lead?.source === "ai_navigator_funnel") engagementScore += 20; // Engaged with AI
