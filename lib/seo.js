...
const DEFAULT_OG_IMAGE = "/images/hero-sydney.svg";
...
export function businessJsonLd(siteData) {
  ...
  return {
    ...
    image: absoluteUrl("/images/brisbane-skyline.svg"),
    logo: absoluteUrl("/images/minrosh-logo.svg"),
    priceRange: "$$",
...
export function articleJsonLd({ title, description, path, datePublished }) {
  return {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: absoluteUrl("/images/minrosh-logo.svg"),
      },
    },
