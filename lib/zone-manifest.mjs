...
export const PROJECT_ZONES = {
  ...
  public: {
    ...
    prefixes: [
      ...
      "components/about/",
      "components/contact/",
      "components/post-study-visa-australia/",
      "components/skilled-migration/",
      "components/student-visa-australia/",
      ...
      "data/site.json",
      "data/news.json",
      "data/destination-planning-blocks.json",
      "data/student-country-planner/",
      "data/tool-disclaimers.json",
      "public/",
    ],
    globs: [
      "app/page.js",
