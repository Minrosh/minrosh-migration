...
export const adminUsersFile = path.join(dataDir, "admin-users.json");
...
/** Ephemeral PNGs for Meta `image_url` / `url` fetches (signed GET). Not committed. */
export const socialImageCacheDir = path.join(dataDir, "social-image-cache");
...
/** Website CMS stores (Sprint 0+ — inactive on public site until wired). */
export const websitePagesFile = path.join(dataDir, "website-pages.json");
export const websiteNavigationFile = path.join(dataDir, "website-navigation.json");
export const websiteFooterFile = path.join(dataDir, "website-footer.json");
export const websiteMediaFile = path.join(dataDir, "website-media.json");
export const websiteComplianceFile = path.join(dataDir, "website-compliance.json");
export const websiteVersionsFile = path.join(dataDir, "website-versions.json");
export const websiteRedirectsFile = path.join(dataDir, "website-redirects.json");
export const websiteMediaStorageDir = path.join(process.cwd(), "storage", "website-media");

export const websitePagesSeed = path.join(dataDir, "website-pages.seed.json");
export const websiteNavigationSeed = path.join(dataDir, "website-navigation.seed.json");
export const websiteFooterSeed = path.join(dataDir, "website-footer.seed.json");
export const websiteMediaSeed = path.join(dataDir, "website-media.seed.json");
export const websiteComplianceSeed = path.join(dataDir, "website-compliance.seed.json");
export const websiteVersionsSeed = path.join(dataDir, "website-versions.seed.json");
export const websiteRedirectsSeed = path.join(dataDir, "website-redirects.seed.json");
...
export const cronRunsFile = path.join(dataDir, "cron-runs.json");
