...
/** Legacy /contact content — kept as fallback when CMS is off, empty, or unreadable. */
export function ContactLegacyPage() {
                  ...
                  <div className="contact-copy">
                    ...
                    <div className="my-5 flex flex-wrap gap-3">
                      <TrackedAnchor
                        ...
                        eventParams={{
                          cta_id: "contact_panel_whatsapp",
                          cta_location: "contact_panel",
                    ...
                    <div className="rounded-2xl bg-brand-plum/[0.03] p-5 border border-brand-plum/5">
                      <p className="text-[10px] font-black uppercase tracking-widest text-brand-plum/40 mb-4">
                      ...
                      <div className="flex flex-wrap gap-4">
                        ...
                        {siteData.brand.phoneSecondary && (
                          <div className="min-w-0 w-full min-[400px]:min-w-[200px] sm:flex-1 space-y-1 rounded-xl border border-brand-plum/10 bg-white/70 p-3">
                            ...
                            <a
                              href={`tel:${siteData.brand.phoneSecondary.replace(/\s+/g, "")}`}
                              className="text-sm font-medium text-brand-plum/70 hover:text-brand-rose transition-colors"
                            >
                              {siteData.brand.phoneSecondary}
                            </a>
                          </div>
