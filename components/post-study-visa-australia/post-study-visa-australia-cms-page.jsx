...
/**
 * Published CMS content for /post-study-visa-australia (Sprint 3e).
 ...
 */
export function PostStudyVisaAustraliaCmsPage({ content }) {
        ...
        <div className="w-full max-w-[var(--content-max)] mx-auto px-[var(--content-pad)]">
          <article className="content-page content-page--premium-guide">
            <BreadcrumbsNav
              ...
              items={[
                { label: "Home", href: "/" },
                { label: "Post-Study Visa", href: pageData.path },
              ]}
            />
